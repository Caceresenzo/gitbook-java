...
public class FeignGitBookErrorDecoder extends ErrorDecoder.Default {
	...
	public FeignGitBookErrorDecoder(ObjectMapper objectMapper) {
		...
		this.mappers = new ArrayList<>();
		{
			...
			this.mappers.add(ErrorMapper.startsWith("SiteSpace not found", GitBookClientException.SpaceNotFound::new));
			...
			this.mappers.add(ErrorMapper.startsWith("No matching page found", GitBookClientException.RevisionPageNotFound::new));

			this.mappers.add(ErrorMapper.startsWithAndEndswith("change request ", " not found", GitBookClientException.ChangeRequestNotFound::new));
		}
	}
